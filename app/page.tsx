      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center text-gray-300 space-y-6">
            <p>
              At CNCF Dehradun, we believe that cloud-native computing has the
              power to transform the way we build, deploy, and scale
              applications. Nestled in the beautiful hill city of Dehradun, in
              the serene state of Uttarakhand, we're at the forefront of
              revolutionizing the software development landscape.
            </p>
            <p>
              Our focus lies in leveraging cutting-edge technologies like
              Kubernetes, microservices, serverless architecture, and
              observability to create scalable, resilient, and efficient
      ...
      <section className="py-20 bg-secondary">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" className="bg-primary hover:bg-primary/90">
            <Link href="https://community.cncf.io/cloud-native-dehradun/">
              Become a Member
            </Link>
          </Button>
        </div>
